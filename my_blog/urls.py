...
urlpatterns = [
    ...
    path('edit-comment/<slug:pk>', views.CommentUpdateView.as_view(), name='update_comment'),
    path('delete-comment/<slug:pk>', views.DeleteCommentView.as_view(), name='delete_comment'),
